 ...
 *   
 *   20 March 2015, Marc Kuniansky, added two functions, fishDistancetoSurface and 
 *                                  fishDistanceToBottom, both modelled after the
...
public class NavigationalAide
{
    ...
    /**
       Compute how far the fish is from the surface of the aquarium.
       
       This method was added as a design choice to simplify the autoMove
       function in the AquaFish class. Verified with Alyse Brady April 20 2015.
       @author Marc Kuniansky
       @return height from top of fish to surface
     */
    protected int fishDistanceToSurface()
    { //Begin fishDistanceToSurface
        int topEdgeOfFish = centerY - (halfHeight + 1); //Get the top edge of the fish to compare to the top of the aquarium.
        return (topEdgeOfFish); //The top of the aquarium is 0, so the distance to the top is the fish's height.
    } //End fishDistanceToSurface
    
    /**
       Compute how far the fish is from the bottom of the aquarium.
       
       This method was added as a design choice to simplify the autoMove
       function in the AquaFish class. Verified with Alyse Brady April 20 2015.
       @author Marc Kuniansky
       @return height from top of fish to bottom
     */
    protected int fishDistanceToBottom()
    { //Begin fishDistanceToBottom
        int bottomEdgeOfFish = centerY + (halfHeight+1); //Get the bottom edge of the fish to compare to the bottom of the aquarium.
        return (theFish.aquarium().height() - bottomEdgeOfFish); //Compare the bottom of the fish to the bottom of the aquarium, and return the distance between them.
    } //End fishDistancetoBottom
