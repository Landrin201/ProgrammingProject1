...
/**
  ...
  Modifications: <br>   
    ...
    20 May 2015, Marc Kuniansky,     Modified to make the time and SpeechToTextStub instance 
                                     variables.
    <br>
  
  @author Marc Kuniansky
  @version Version 3, 20 May 2015
  **/
public class TalkingRobot
{ //Begin class
    //Instance variables
    private Clock clock;
    private SpeechToTextStub question;
    /**
     * Constructs a TalkingRobot object
     */
    public TalkingRobot()
    { //Begin constructor
        clock = new Clock();
        question = new SpeechToTextStub();
    } //End constructor
    ...
    { //Begin respondTo
        String fullQuestion = question.getQuestion();
        System.out.println(fullQuestion);
        String theQuestion = fullQuestion.toLowerCase(); //Make the question lower case to avoid confusion later, and store it to theQuestion.
