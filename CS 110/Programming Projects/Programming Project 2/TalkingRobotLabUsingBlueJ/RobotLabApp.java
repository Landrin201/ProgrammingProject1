...
{ //Begin class
    /**
       ...
       to tell the robot to say a phrase. It then has the robot answer three
    ...
    { //Begin main
        ...
        ryanBot.sayAPhrase(timeCheck);
        
        //Add a separator line, to make it look nicer.
        System.out.println("__________________________________________________________");
        //Question part
        SpeechToTextStub questionGenerator = new SpeechToTextStub(); //Call the SpeechToText class
            
        int numberQuestions = 15;
        for(int i=0; i<numberQuestions; i++)
            {
                String newQuestion = questionGenerator.getQuestion(); //Make a question using the questionGenerator method from the SpeechToText class
                ryanBot.respondTo(newQuestion);
            }
